...
1. incident_type (Инцидент или Запрос):
   ...
   - Поломка/разрушение (сломалось, лопнуло, прорвало, течет)
   - Блокировка/засор (не работает, забито, не уходит, засор)
   - УГРОЗА: риск жизни, здоровью, имуществу (затопление, замыкание, падение)
   - НЕИСПРАВНОСТЬ оборудования

   "Запрос" = ХОЧЕТ ЧТО-ТО (не проблема):
   - Информацию (спросить, узнать, почему, когда)
   - Дополнительную услугу (установить, заменить, подключить, монтаж)
