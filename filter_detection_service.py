...
3. category (категория из списка выше):
   - Используй СМЫСЛОВОЙ анализ текста обращения
   - Синонимы, семантическая близость к названию категории
   - Контекст проблемы (течет вода → Водоснабжение, не уходит вода → Канализация)
   - УКАЗЫВАЙ категорию ТОЛЬКО при 90%+ уверенности, иначе null
