...
5. category: УКАЗЫВАЙ только при 100% уверенности, иначе null
   - БАТАРЕЯ/РАДИАТОР/ОТОПЛЕНИЕ = "Отопление"
   - ТРУБА/ПРОРЫВ ТРУБЫ/ТЕЧЕТ ИЗ ТРУБЫ = "Водоснабжение" (А НЕ Канализация!)
   - ЗАСОР/ЗАБИТА/НЕ УХОДИТ = "Канализация"
