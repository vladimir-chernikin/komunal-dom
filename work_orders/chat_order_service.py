...
from work_orders.chat_order import ChatOrderPayloadBuilder, ServiceObjectCompanyResolver
...
class ChatOrderService:
    """Creates a normalized JSON payload and a real work order from chat state."""

    def __init__(self):
        self.payload_builder = ChatOrderPayloadBuilder()
    ...
    def create_from_chat(
        ...
        **legacy_kwargs,
        ...
        if order_context is None:
            order_context = legacy_kwargs.get("intake_context") or {}
        ...
        existing_work_order_id = order_context.get("work_order_id")
        ...
        with transaction.atomic():
            ...
            WorkOrderEventLog.objects.create(
                ...
                text_value=f"Заявка создана из чата ({channel}).",
                event_payload_json={
